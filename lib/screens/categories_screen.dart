...
class _CategoriesScreenState extends ConsumerState<CategoriesScreen> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Explore spending by category across your entire history',
              ...
              data: (summaries) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, i) => _categoryTile(
                      theme, visible[i], state.selected.contains(
                          visible[i].category)),
                );
              },
            ),
            ...
            child: Row(
              children: [
                ...
                SizedBox(
                  width: 17,
                  child:
                      FaIcon(categoryIcon(s.category), size: 13, color: accent),
                ),
        ...
        children: [
          ...
          if (state.hasPeriod)
            ...
            ActionChip(
              avatar: const Icon(Icons.date_range, size: 14),
              label:
                  const Text('Custom period…', style: TextStyle(fontSize: 12)),
              onPressed: _pickRange,
            ),
        ],
      ),
  ...
  String _fmtIso(DateTime d) => '${d.year.toString().padLeft(4, '0')}-'
        ...
        Padding(
          ...
          child: LayoutBuilder(builder: (context, c) {
            ...
            return Wrap(
              ...
              runSpacing: gap,
              children: [
                _kpi(theme, w, 'Total spent', currency0.format(total),
                    Icons.south_west, cs.error),
                _kpi(
                    theme,
                    w,
                    'Transactions',
                    ...
                    Icons.receipt_long,
                    cs.primary),
                _kpi(theme, w, 'Avg / month', currency0.format(avgPerMonth),
                    Icons.calendar_view_month, cs.tertiary),
                _kpi(theme, w, 'Largest', currency0.format(largest),
                    Icons.trending_up, cs.error),
              ],
            );
          }),
        ),
  ...
  Widget _tableRow(ThemeData theme, Expense tx, int i) {
    ...
    Widget cell(String v, double? width,
        {bool right = false, Color? color, FontWeight? weight}) {
      final text = Text(
        v,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          cell(tx.source, 100),
          cell(currency2.format(amount), 110,
              right: true,
